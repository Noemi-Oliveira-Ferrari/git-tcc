...
public class CadastroProfissionalActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cvSuccess = findViewById(R.id.cv_success);
        btnLogin = findViewById(R.id.btn_success);

        cvOpacity.setVisibility(View.INVISIBLE);
        cvSuccess.setVisibility(View.INVISIBLE);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CadastroProfissionalActivity2.this, MainActivity.class);
                startActivity(intent);
            }
        });
