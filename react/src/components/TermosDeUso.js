   ...
   render(){
    return(
        <div class="flex-center">
            <div class="card-formulario-termos">
                <h3 class="title-card">Termos de Uso</h3>
                <div class="flex-center caixa-termos">
                ...
                <div class="caixa-confirmacao ">
                    <input type="checkbox" value="" class="confirmar-termos"/>Declaro estar ciente com os <a href="#" class="">Termos de Uso e Politica de privacidade </a>
                </div>
                <div class="caixa-dir">
                    <button class="btn-voltar" value="">Voltar</button>
                </div>
                <div class="caixa-esq">
                    <button class="btn-prox" value="">Continuar</button>
                </div>
            </div>
        </div>
