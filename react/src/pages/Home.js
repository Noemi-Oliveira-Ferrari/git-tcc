            ...
            <div class="conteudo-avaliacoes-home">
                <section class="customer-slider-avaliacao">
                    <div class="slide-avalicao-home">
                        ...
                        <p class="texto-comentario-usuario-home"> Òtimo profissional, chegou no horario e deixou o local limpo </p>
                    ...
                    <div class="slide-avalicao-home">
                        ...
                        {/* <hr class="linha-comentario-usuario-home"/> */}
                        <p class="texto-comentario-usuario-home">Moço bem bonzinho, bem simpatico, mto organizado e fez o trabalho mto bem </p>
                        <div class="caixa-btn-home">
                            <button class="ver-mais-comentario-home">Ver mais</button>
                        </div>
                    </div>
                    <div class="slide-avalicao-home">
                        ...
                        {/* <hr class="linha-comentario-usuario-home"/> */}
                        <p class="texto-comentario-usuario-home">Cumpriu com o horário marcado, bem organizado e concluiu o trabalho com eficacia  </p>
                        <div class="caixa-btn-home">
                            <button class="ver-mais-comentario-home">Ver mais</button>
                        </div>
                    </div>
                    <div class="slide-avalicao-home">
                        ...
                        {/* <hr class="linha-comentario-usuario-home"/> */}
                        <p class="texto-comentario-usuario-home">Executou o serviço muito bem, contrataria denovo </p>
                        <div class="caixa-btn-home">
                            <button class="ver-mais-comentario-home">Ver mais</button>
                        </div>
                    </div>
